...
public class PdfWriter {
    ...
    */
    public static class Static {
         ...
         * Optional key/value parameter pairs fileName, xml, xsl
         * @param request
         * @param response
         * @param parameters
         * @throws IOException
         ...
         */
        public static void doService(HttpServletRequest request, HttpServletResponse response, Object... parameters)
            ...
            try {
                FopFactory fopFactory = PdfWriter.Static.getFopFactory();
