...
CREATE TABLE RecordLocation3 (
    ...
    CONSTRAINT pk_rl3_symbolid_id PRIMARY KEY (symbolId, typeId, id)
) TABLESPACE dari;
...
CREATE TABLE RecordNumber3 (
  ...
  TABLESPACE dari;
CREATE INDEX k_rn3_id ON RecordNumber3 (id);
...
CREATE INDEX k_ru_typeId_updateDate ON RecordUpdate (typeId, updateDate);
...
CREATE TABLE RecordUuid3 (
    ...
    CONSTRAINT pk_ru3_symbolid_value_type_id PRIMARY KEY (symbolId, value, typeId, id)
) ORGANIZATION INDEX COMPRESS
  TABLESPACE dari;
